...
///日期弹窗显示
class CustomSingleChooseDatePicker extends StatefulWidget {
  CustomSingleChooseDatePicker({
    Key? key,
  ...
  @override
  CustomSingleChooseDatePickerState createState() =>
      CustomSingleChooseDatePickerState();
}

class CustomSingleChooseDatePickerState
    extends State<CustomSingleChooseDatePicker> {
  ...
  @override
  void didUpdateWidget(CustomSingleChooseDatePicker oldWidget) {
      ...
      case DatePickerMode.year:
        return Padding(
          ...
          child: _YearPicker(
            ...
            selectedYearDecoration: widget.selectedDateDecoration,
          ),
        );
    }
  }
    ...
    return Stack(
      children: <Widget>[
        ...
        _DatePickerModeToggleButton(
          ...
          textStyle: widget.yearTextStyle,
        ),
      ],
    );
  }
...
class _DayPickerState extends State<_DayPicker> {
    ...
    for (int i = localizations.firstDayOfWeekIndex; true; i = (i + 1) % 7) {
      ...
      result.add(ExcludeSemantics(
        child: Center(
            child: Text(weekday,
                style: i == 0 || i == 6
                    ? widget.weekendTextStyle ?? widget.weekTextStyle
                    : headerStyle)),
      ));
  ...
  Widget build(BuildContext context) {
    ...
    final TextTheme textTheme = Theme.of(context).textTheme;
    final TextStyle? headerStyle = textTheme.titleSmall?.apply(
      color: colorScheme.onSurface.withOpacity(0.60),
    );
    final TextStyle dayStyle = textTheme.titleSmall!;
    final Color enabledDayColor = colorScheme.onSurface.withOpacity(0.87);
    final Color disabledDayColor = colorScheme.onSurface.withOpacity(0.38);
    final Color selectedDayColor = colorScheme.onPrimary;
    final Color selectedDayBackground = colorScheme.primary;
    // final Color todayColor = colorScheme.primary;
    final Color todayColor = Color(0xff4D6FD5);
...
class _YearPickerState extends State<_YearPicker> {
  ...
  Widget _buildYearItem(BuildContext context, int index) {
    ...
    BoxDecoration? decoration;
    if (isSelected) {
      decoration = widget.selectedYearDecoration ??
          BoxDecoration(
